...
3. **Install hooks (optional but recommended)**
   ...
   ```
   This installs a pre-commit hook that checks VERSION sync when releasing. See [Versioning](docs/guides/versioning.md).
...
Flagent follows Kotlin Coding Conventions. See [.cursorrules](.cursorrules) for detailed guidelines.
...
- Update [docs/](docs/) for user-facing documentation
...
- [Documentation](docs/guides/getting-started.md) - Read the documentation
