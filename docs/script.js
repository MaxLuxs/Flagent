...
const translations = {
    ru: {
        ...
        'overview.desc': 'Flagent предоставляет несколько типов SDK для различных платформ и случаев использования. Все SDK генерируются из OpenAPI спецификации и совместимы с Flagent API версии 0.1.x.',
        ...
        'compatibility.desc': 'Все SDK генерируются из OpenAPI спецификации и совместимы с Flagent API версии 0.1.x. OpenAPI спецификация доступна по адресу http://localhost:18000/api/v1/openapi.yaml когда сервер запущен.',
        // Quick Start page
    ...
    en: {
        ...
        'sdk.header.subtitle': 'Client libraries (SDK) for Flagent API - feature flagging, A/B testing and dynamic configuration microservice',
        'overview.title': 'SDK Structure',
        'overview.desc': 'Flagent provides several types of SDKs for different platforms and use cases. All SDKs are generated from OpenAPI specification and are compatible with Flagent API version 0.1.x.',
        'overview.base.title': 'Base SDK',
        ...
        'compatibility.title': 'API Compatibility',
        'compatibility.desc': 'All SDKs are generated from OpenAPI specification and are compatible with Flagent API version 0.1.x. OpenAPI specification is available at http://localhost:18000/api/v1/openapi.yaml when server is running.',
        // Quick Start page
        'quickstart.title': 'Flagent Quick Start Guide',
        'quickstart.header.title': 'Quick Start Guide',
