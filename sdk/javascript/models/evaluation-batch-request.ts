...
export interface EvaluationBatchRequest {
     ...
     */
    'flagIDs'?: Array<number> | null;
    /**
     * FlagKeys. Either flagIDs, flagKeys or flagTags works. If pass in multiples, Flagent may return duplicate results.
     */
    'flagKeys'?: Array<string> | null;
    /**
     * FlagTags. Either flagIDs, flagKeys or flagTags works. If pass in multiples, Flagent may return duplicate results.
     */
    'flagTags'?: Array<string> | null;
    /**
     * Determine how flagTags is used to filter flags to be evaluated.
     */
    'flagTagsOperator'?: EvaluationBatchRequestFlagTagsOperatorEnum | null;
}

export const EvaluationBatchRequestFlagTagsOperatorEnum = {
    Any: 'ANY',
    All: 'ALL'
} as const;

export type EvaluationBatchRequestFlagTagsOperatorEnum = typeof EvaluationBatchRequestFlagTagsOperatorEnum[keyof typeof EvaluationBatchRequestFlagTagsOperatorEnum];
