...
import com.flagent.client.auth.*
...
open class ApiClient(
    ...
    constructor(
        ...
        client = HttpClient((httpClientEngine ?: createDefaultHttpClientEngine()), clientConfig)
    }
    ...
    companion object {
        const val BASE_URL: String = "http://localhost:18000/api/v1"
