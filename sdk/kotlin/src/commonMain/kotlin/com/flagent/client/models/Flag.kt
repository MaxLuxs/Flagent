...
data class Flag (
    ...
    @SerialName(value = "dataRecordsEnabled") @Required val dataRecordsEnabled: kotlin.Boolean,

    @SerialName(value = "snapshotID") val snapshotID: kotlin.Long? = null,
    ...
    @SerialName(value = "segments") val segments: kotlin.collections.List<Segment>? = null,

    @SerialName(value = "variants") val variants: kotlin.collections.List<Variant>? = null,
