...
class ExportApi {
  ...
  Future<Response<BuiltMap<String, JsonObject>>> getExportEvalCacheJSON({ 
    ...
    final _path = r'/export/eval_cache/json';
  ...
  ///
  /// Parameters:
  /// * [excludeSnapshots] - Export without snapshots data - useful for smaller db without snapshots
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<Uint8List>> getExportSQLite({ 
    ...
    final _queryParameters = <String, dynamic>{
      if (excludeSnapshots != null) r'exclude_snapshots': encodeQueryParameter(_serializers, excludeSnapshots, const FullType(bool)),
    };
