...
import 'package:flagent_client/src/serializers.dart';
import 'package:flagent_client/src/auth/api_key_auth.dart';
import 'package:flagent_client/src/auth/basic_auth.dart';
import 'package:flagent_client/src/auth/bearer_auth.dart';
import 'package:flagent_client/src/auth/oauth.dart';
import 'package:flagent_client/src/api/constraint_api.dart';
import 'package:flagent_client/src/api/distribution_api.dart';
import 'package:flagent_client/src/api/evaluation_api.dart';
import 'package:flagent_client/src/api/export_api.dart';
import 'package:flagent_client/src/api/flag_api.dart';
import 'package:flagent_client/src/api/health_api.dart';
import 'package:flagent_client/src/api/segment_api.dart';
import 'package:flagent_client/src/api/tag_api.dart';
import 'package:flagent_client/src/api/variant_api.dart';

class FlagentClient {
  static const String basePath = r'http://localhost:18000/api/v1';
