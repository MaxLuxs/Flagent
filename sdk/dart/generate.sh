...
# Generate Dart SDK from OpenAPI specification
...
echo "Generating Dart SDK from $OPENAPI_SPEC..."
...
# Generate Dart Dio client
$GENERATOR_CMD generate \
    -i "$OPENAPI_SPEC" \
    -g dart-dio \
    -o "$OUTPUT_DIR" \
    --additional-properties=pubName=flagent_client,pubVersion=0.1.7,pubDescription=Flagent_API_client,pubAuthor=Flagent_Team,pubHomepage=https://github.com/MaxLuxs/Flagent
