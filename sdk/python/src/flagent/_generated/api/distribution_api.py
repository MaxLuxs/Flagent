...
class DistributionApi:
    ...
    async def find_distributions(
        ...
        _param = self._find_distributions_serialize(
            flag_id=flag_id,
    ...
    @validate_call
    async def find_distributions_with_http_info(
        self,
        flag_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the flag")],
        segment_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the segment")],
        _request_timeout: Union[
    ...
    @validate_call
    async def find_distributions_without_preload_content(
        self,
        flag_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the flag")],
        segment_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the segment")],
        _request_timeout: Union[
    ...
    def _find_distributions_serialize(
        self,
        flag_id,
        segment_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/flags/{flagId}/segments/{segmentId}/distributions',
    ...
    async def put_distributions(
        ...
        flag_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the flag")],
        segment_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the segment")],
        put_distributions_request: PutDistributionsRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param segment_id: Numeric ID of the segment (required)
        :type segment_id: int
        :param put_distributions_request: (required)
        :type put_distributions_request: PutDistributionsRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._put_distributions_serialize(
            flag_id=flag_id,
            segment_id=segment_id,
            put_distributions_request=put_distributions_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    async def put_distributions_with_http_info(
        self,
        flag_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the flag")],
        segment_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the segment")],
        put_distributions_request: PutDistributionsRequest,
    ...
    @validate_call
    async def put_distributions_without_preload_content(
        self,
        flag_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the flag")],
        segment_id: Annotated[int, Field(strict=True, ge=1, description="Numeric ID of the segment")],
        put_distributions_request: PutDistributionsRequest,
    ...
    def _put_distributions_serialize(
        self,
        flag_id,
        segment_id,
        ...
        # process the form parameters
        # process the body parameter
        if put_distributions_request is not None:
            _body_params = put_distributions_request
