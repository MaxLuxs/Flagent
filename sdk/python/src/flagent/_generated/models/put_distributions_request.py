...
class PutDistributionsRequest(BaseModel):
    """
    PutDistributionsRequest
    """ # noqa: E501
    distributions: List[DistributionRequest]
    __properties: ClassVar[List[str]] = ["distributions"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutDistributionsRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutDistributionsRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "distributions": [DistributionRequest.from_dict(_item) for _item in obj["distributions"]] if obj.get("distributions") is not None else None
        })
        return _obj
