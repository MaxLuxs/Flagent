...
class CreateFlagRequest(BaseModel):
    ...
    key: Optional[StrictStr] = Field(default=None, description="Unique key representation of the flag")
    template: Optional[StrictStr] = Field(default=None, description="Template for flag creation")
    __properties: ClassVar[List[str]] = ["description", "key", "template"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateFlagRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateFlagRequest from a dict"""
        if obj is None:
            return None
