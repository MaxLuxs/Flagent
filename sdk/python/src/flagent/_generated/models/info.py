...
class Info(BaseModel):
    ...
    Info
    """ # noqa: E501
    version: Optional[StrictStr] = Field(default=None, description="Application version")
    build_time: Optional[StrictStr] = Field(default=None, description="Build timestamp", alias="buildTime")
    git_commit: Optional[StrictStr] = Field(default=None, description="Git commit hash", alias="gitCommit")
    __properties: ClassVar[List[str]] = ["version", "buildTime", "gitCommit"]
