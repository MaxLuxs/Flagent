...
class EvaluationBatchRequest(BaseModel):
    ...
    """ # noqa: E501
    entities: Annotated[List[EvaluationEntity], Field(min_length=1)]
    enable_debug: Optional[StrictBool] = Field(default=False, alias="enableDebug")
    flag_ids: Optional[List[StrictInt]] = Field(default=None, description="FlagIDs. Either flagIDs, flagKeys or flagTags works. If pass in multiples, Flagent may return duplicate results.", alias="flagIDs")
    flag_keys: Optional[List[StrictStr]] = Field(default=None, description="FlagKeys. Either flagIDs, flagKeys or flagTags works. If pass in multiples, Flagent may return duplicate results.", alias="flagKeys")
    flag_tags: Optional[List[StrictStr]] = Field(default=None, description="FlagTags. Either flagIDs, flagKeys or flagTags works. If pass in multiples, Flagent may return duplicate results.", alias="flagTags")
    flag_tags_operator: Optional[StrictStr] = Field(default='ANY', description="Determine how flagTags is used to filter flags to be evaluated.", alias="flagTagsOperator")
    __properties: ClassVar[List[str]] = ["entities", "enableDebug", "flagIDs", "flagKeys", "flagTags", "flagTagsOperator"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvaluationBatchRequest from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # set to None if flag_ids (nullable) is None
        # and model_fields_set contains the field
        if self.flag_ids is None and "flag_ids" in self.model_fields_set:
            _dict['flagIDs'] = None

        # set to None if flag_keys (nullable) is None
        # and model_fields_set contains the field
        if self.flag_keys is None and "flag_keys" in self.model_fields_set:
            _dict['flagKeys'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvaluationBatchRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "entities": [EvaluationEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "enableDebug": obj.get("enableDebug") if obj.get("enableDebug") is not None else False,
            "flagIDs": obj.get("flagIDs"),
            "flagKeys": obj.get("flagKeys"),
