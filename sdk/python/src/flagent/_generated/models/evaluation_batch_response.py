...
class EvaluationBatchResponse(BaseModel):
    ...
    """ # noqa: E501
    evaluation_results: List[EvalResult] = Field(alias="evaluationResults")
    __properties: ClassVar[List[str]] = ["evaluationResults"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvaluationBatchResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvaluationBatchResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "evaluationResults": [EvalResult.from_dict(_item) for _item in obj["evaluationResults"]] if obj.get("evaluationResults") is not None else None
        })
        return _obj
