...
class EvaluationEntity(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["entityID", "entityType", "entityContext"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EvaluationEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EvaluationEntity from a dict"""
        if obj is None:
            return None
