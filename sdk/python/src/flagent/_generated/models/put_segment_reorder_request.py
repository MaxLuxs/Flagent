...
class PutSegmentReorderRequest(BaseModel):
    """
    PutSegmentReorderRequest
    """ # noqa: E501
    segment_ids: Annotated[List[Annotated[int, Field(strict=True, ge=1)]], Field(min_length=1)] = Field(alias="segmentIDs")
    __properties: ClassVar[List[str]] = ["segmentIDs"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutSegmentReorderRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutSegmentReorderRequest from a dict"""
        if obj is None:
            return None
