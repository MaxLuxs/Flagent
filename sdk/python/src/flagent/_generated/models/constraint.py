...
class Constraint(BaseModel):
    ...
    var_property: Annotated[str, Field(min_length=1, strict=True)] = Field(alias="property")
    operator: StrictStr
    value: Annotated[str, Field(min_length=1, strict=True)]
    __properties: ClassVar[List[str]] = ["id", "segmentID", "property", "operator", "value"]

    @field_validator('operator')
    def operator_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['EQ', 'NEQ', 'LT', 'LTE', 'GT', 'GTE', 'EREG', 'NEREG', 'IN', 'NOTIN', 'CONTAINS', 'NOTCONTAINS']):
            raise ValueError("must be one of enum values ('EQ', 'NEQ', 'LT', 'LTE', 'GT', 'GTE', 'EREG', 'NEREG', 'IN', 'NOTIN', 'CONTAINS', 'NOTCONTAINS')")
        return value
