...
class SegmentDebugLog(BaseModel):
    """
    SegmentDebugLog
    """ # noqa: E501
    segment_id: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, alias="segmentID")
    msg: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["segmentID", "msg"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SegmentDebugLog from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SegmentDebugLog from a dict"""
        if obj is None:
            return None
