...
class PutSegmentRequest(BaseModel):
    """
    PutSegmentRequest
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["description", "rolloutPercent"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PutSegmentRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PutSegmentRequest from a dict"""
        if obj is None:
            return None
