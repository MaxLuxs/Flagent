...
from flagent._generated.api.distribution_api import DistributionApi


class TestDistributionApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_find_distributions(self) -> None:
    ...
    async def test_put_distributions(self) -> None:
