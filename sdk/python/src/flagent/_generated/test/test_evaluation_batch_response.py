...
class TestEvaluationBatchResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> EvaluationBatchResponse:
        ...
        if include_optional:
            return EvaluationBatchResponse(
                evaluation_results = [
                    {"flagID":1,"flagKey":"new_feature","flagSnapshotID":1,"flagTags":[],"segmentID":1,"variantID":1,"variantKey":"control","variantAttachment":{},"evalContext":{"entityID":"user123","entityType":"user","entityContext":{"region":"US","tier":"premium"}},"timestamp":"2024-01-01T00:00:00Z"}
                    ]
            )
        else:
            return EvaluationBatchResponse(
