...
class TestPutConstraintRequest(unittest.TestCase):
    """PutConstraintRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PutConstraintRequest:
        """Test PutConstraintRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PutConstraintRequest`
        """
        model = PutConstraintRequest()
        if include_optional:
            return PutConstraintRequest(
                var_property = '0',
                operator = '',
                value = '0'
            )
    ...
    def testPutConstraintRequest(self):
        """Test PutConstraintRequest"""
