    ...
    def make_instance(self, include_optional) -> EvalResult:
        ...
        if include_optional:
            return EvalResult(
                ...
                variant_key = '',
                variant_attachment = { },
                eval_context = {"flagID":1,"entityID":"user123","entityType":"user","entityContext":{"region":"US","tier":"premium"},"enableDebug":false},
                timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'),
                eval_debug_log = {"msg":"Evaluation completed","segmentDebugLogs":[{"segmentID":1,"msg":"Segment matched"}]}
            )
        else:
            return EvalResult(
        )
