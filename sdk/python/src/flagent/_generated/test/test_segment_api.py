...
from flagent._generated.api.segment_api import SegmentApi


class TestSegmentApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_segment(self) -> None:
    ...
    async def test_find_segments(self) -> None:
    ...
    async def test_put_segment(self) -> None:
    ...
    async def test_put_segment_reorder(self) -> None:
        """Test case for put_segment_reorder
