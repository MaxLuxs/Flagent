...
from flagent._generated.api.constraint_api import ConstraintApi


class TestConstraintApi(unittest.IsolatedAsyncioTestCase):
    """ConstraintApi unit test stubs"""

    async def asyncSetUp(self) -> None:
        self.api = ConstraintApi()

    async def asyncTearDown(self) -> None:
        await self.api.api_client.close()

    async def test_create_constraint(self) -> None:
    ...
    async def test_delete_constraint(self) -> None:
    ...
    async def test_find_constraints(self) -> None:
    ...
    async def test_put_constraint(self) -> None:
