...
from flagent._generated.api.tag_api import TagApi


class TestTagApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_flag_tag(self) -> None:
        """Test case for create_flag_tag

        Create tag and associate with flag
        """
        pass

    async def test_delete_flag_tag(self) -> None:
        """Test case for delete_flag_tag

        Remove tag from flag
        """
        pass

    async def test_find_all_tags(self) -> None:
    ...
    async def test_find_flag_tags(self) -> None:
        """Test case for find_flag_tags
