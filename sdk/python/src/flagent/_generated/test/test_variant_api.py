...
from flagent._generated.api.variant_api import VariantApi


class TestVariantApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_create_variant(self) -> None:
    ...
    async def test_delete_variant(self) -> None:
    ...
    async def test_find_variants(self) -> None:
    ...
    async def test_put_variant(self) -> None:
