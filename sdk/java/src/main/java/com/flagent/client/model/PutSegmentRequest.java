 ...
 */
@JsonPropertyOrder({
  PutSegmentRequest.JSON_PROPERTY_DESCRIPTION,
  PutSegmentRequest.JSON_PROPERTY_ROLLOUT_PERCENT
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.18.0")
public class PutSegmentRequest {
  ...
  public PutSegmentRequest() { 
  }

  public PutSegmentRequest description(@jakarta.annotation.Nonnull String description) {
  ...
  public PutSegmentRequest rolloutPercent(@jakarta.annotation.Nonnull Long rolloutPercent) {
  ...
  /**
   * Return true if this PutSegmentRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PutSegmentRequest putSegmentRequest = (PutSegmentRequest) o;
    return Objects.equals(this.description, putSegmentRequest.description) &&
        Objects.equals(this.rolloutPercent, putSegmentRequest.rolloutPercent);
  }
