...
import com.flagent.client.model.DistributionRequest;
 ...
 */
@JsonPropertyOrder({
  PutDistributionsRequest.JSON_PROPERTY_DISTRIBUTIONS
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.18.0")
public class PutDistributionsRequest {
  public static final String JSON_PROPERTY_DISTRIBUTIONS = "distributions";
  @jakarta.annotation.Nonnull
  private List<DistributionRequest> distributions = new ArrayList<>();

  public PutDistributionsRequest() { 
  }

  public PutDistributionsRequest distributions(@jakarta.annotation.Nonnull List<DistributionRequest> distributions) {
    this.distributions = distributions;
    return this;
  }

  public PutDistributionsRequest addDistributionsItem(DistributionRequest distributionsItem) {
   ...
   */
  @jakarta.annotation.Nonnull
  @JsonProperty(value = JSON_PROPERTY_DISTRIBUTIONS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public List<DistributionRequest> getDistributions() {
    return distributions;
  }
  ...
  @JsonProperty(value = JSON_PROPERTY_DISTRIBUTIONS, required = true)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setDistributions(@jakarta.annotation.Nonnull List<DistributionRequest> distributions) {
    this.distributions = distributions;
  }


  /**
   * Return true if this PutDistributionsRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    PutDistributionsRequest putDistributionsRequest = (PutDistributionsRequest) o;
    return Objects.equals(this.distributions, putDistributionsRequest.distributions);
  }
