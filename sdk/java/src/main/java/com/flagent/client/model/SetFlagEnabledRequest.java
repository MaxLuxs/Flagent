 ...
 */
@JsonPropertyOrder({
  SetFlagEnabledRequest.JSON_PROPERTY_ENABLED
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.18.0")
public class SetFlagEnabledRequest {
  public static final String JSON_PROPERTY_ENABLED = "enabled";
  @jakarta.annotation.Nonnull
  private Boolean enabled;

  public SetFlagEnabledRequest() { 
  }

  public SetFlagEnabledRequest enabled(@jakarta.annotation.Nonnull Boolean enabled) {
  ...
  /**
   * Return true if this SetFlagEnabledRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SetFlagEnabledRequest setFlagEnabledRequest = (SetFlagEnabledRequest) o;
    return Objects.equals(this.enabled, setFlagEnabledRequest.enabled);
  }
