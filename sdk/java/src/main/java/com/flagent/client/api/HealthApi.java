...
public class HealthApi {
   ...
   * @throws ApiException if fails to make API call
   */
  public Health getHealth(Map<String, String> headers) throws ApiException {
    ApiResponse<Health> localVarResponse = getHealthWithHttpInfo(headers);
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Health> getHealthWithHttpInfo(Map<String, String> headers) throws ApiException {
   ...
   * @throws ApiException if fails to make API call
   */
  public Info getInfo(Map<String, String> headers) throws ApiException {
    ApiResponse<Info> localVarResponse = getInfoWithHttpInfo(headers);
    return localVarResponse.getData();
  }
  ...
  public ApiResponse<Info> getInfoWithHttpInfo() throws ApiException {
    return getInfoWithHttpInfo(null);
  }
   ...
   * @throws ApiException if fails to make API call
   */
  public ApiResponse<Info> getInfoWithHttpInfo(Map<String, String> headers) throws ApiException {
    HttpRequest.Builder localVarRequestBuilder = getInfoRequestBuilder(headers);
    try {
      HttpResponse<InputStream> localVarResponse = memberVarHttpClient.send(
          localVarRequestBuilder.build(),
          HttpResponse.BodyHandlers.ofInputStream());
      ...
      try {
        ...
        String responseBody = new String(localVarResponseBody.readAllBytes());
        Info responseValue = responseBody.isBlank()? null: memberVarObjectMapper.readValue(responseBody, new TypeReference<Info>() {});
  ...
  private HttpRequest.Builder getInfoRequestBuilder(Map<String, String> headers) throws ApiException {
