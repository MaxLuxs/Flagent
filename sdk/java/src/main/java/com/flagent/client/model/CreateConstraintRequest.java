 ...
 */
@JsonPropertyOrder({
  CreateConstraintRequest.JSON_PROPERTY_PROPERTY,
  CreateConstraintRequest.JSON_PROPERTY_OPERATOR,
  CreateConstraintRequest.JSON_PROPERTY_VALUE
})
...
public class CreateConstraintRequest {
  ...
  public CreateConstraintRequest property(@jakarta.annotation.Nonnull String property) {
  ...
  public CreateConstraintRequest operator(@jakarta.annotation.Nonnull String operator) {
  ...
  public CreateConstraintRequest value(@jakarta.annotation.Nonnull String value) {
    this.value = value;
    return this;
  }
  ...
  /**
   * Return true if this CreateConstraintRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    CreateConstraintRequest createConstraintRequest = (CreateConstraintRequest) o;
    return Objects.equals(this.property, createConstraintRequest.property) &&
        Objects.equals(this.operator, createConstraintRequest.operator) &&
        Objects.equals(this.value, createConstraintRequest.value);
  }
