...
# Generate Swift SDK from OpenAPI specification
...
echo "Generating Swift SDK from $OPENAPI_SPEC..."
...
$GENERATOR_CMD generate \
    ...
    -g swift5 \
    -o "$OUTPUT_DIR" \
    --additional-properties=projectName=FlagentClient,responseAs=Combine,nonPublicApi=false,useSPMFileStructure=true

echo "Swift SDK generated successfully in $OUTPUT_DIR"
