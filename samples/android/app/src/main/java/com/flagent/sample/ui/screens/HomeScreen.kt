...
fun HomeScreen(
    ...
    Column(
        ...
        verticalArrangement = Arrangement.spacedBy(16.dp)
            ...
            Text(
                text = "This app shows how to use the Flagent SDK: evaluate feature flags (single and batch), use the enhanced client with cache, and inspect configuration. Configure the backend URL in Settings.",
            ...
            Card(
                ...
                Column(
                    ...
                    Text(
                        text = "Start the backend: ./gradlew :backend:runDev — then run scripts/seed-demo-data.sh to create demo flags. For the emulator, set Base URL to http://10.0.2.2:18000/api/v1 in Settings.",
